...
class NotificationService:
    @staticmethod
    def notify_appointment_created(patient_id, doctor_name, appointment_date):
    ...
    @staticmethod
    def notify_appointment_status_changed(patient_id, doctor_name, status):
        try:
            with DbPool.cursor() as cur:
                notification_manager = NotificationQueryManager(cur)
                notification_manager.insert_notification(
    ...
    @staticmethod
    def notify_prescription_created(patient_id, doctor_name):
        try:
            with DbPool.cursor() as cur:
                notification_manager = NotificationQueryManager(cur)
                notification_manager.insert_notification(
    ...
    @staticmethod
    def notify_account_activated(user_id, email):
